...
# Form implementation generated from reading ui file '/Users/miguellopez/Desktop/PROYECTS/PAGOS/ARENERO-RAMIRO/FRONTEND/views/QT_DESIGNS/designs/evacuateConfirmationAccept.ui'
#
...
class UiForm(object):
    ...
    def setupUi(self, Form):
        ...
        Form.setMinimumSize(QtCore.QSize(280, 100))
        Form.setMaximumSize(QtCore.QSize(280, 100))
...
"    }")
        ...
        self.acceptConfirmEvacuatePushButton.clicked.connect(self.closeEvacuateConfirmationAccepted)

        QtCore.QMetaObject.connectSlotsByName(Form)

    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "CONFIRMACIÓN DE EVACUACIÓN AEPTADA"))
        self.messageLabel.setText(_translate("Form", "Usuario EVACUADO con éxito"))
        self.acceptConfirmEvacuatePushButton.setText(_translate("Form", "Aceptar"))

    def showEvacuateConfirmationAccepted(self):
        self.evacuateConfirmationAcceptedWidgetInstance = QtWidgets.QWidget()
        # self.registerWidgetInstance.setWindowIcon(QtGui.QIcon(":/images/fact.png"))
        self.setupUi(self.evacuateConfirmationAcceptedWidgetInstance)
        UiForm.formInstance = self.evacuateConfirmationAcceptedWidgetInstance
        self.evacuateConfirmationAcceptedWidgetInstance.show()

    @staticmethod
    def closeEvacuateConfirmationAccepted():
